...
# echo -e >> /scripts/docker/merged_list_file.sh
# echo "============== shylocks ==============" >> /scripts/docker/merged_list_file.sh
# curl https://raw.githubusercontent.com/shylocks/Loon/main/docker/crontab_list.sh >> /scripts/docker/merged_list_file.sh
